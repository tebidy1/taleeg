...
exports.FREE_TRIAL_ORDER = void 0;
...
function getMockMission(missionId) {
    if (missionId && MISSIONS[missionId])
        return MISSIONS[missionId];
    return MISSIONS[exports.FREE_TRIAL_ORDER[0]];
}
const MISSION_TEASERS = {
...
function listMissions() {
    return exports.FREE_TRIAL_ORDER.map(id => ({
