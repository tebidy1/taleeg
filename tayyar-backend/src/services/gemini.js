...
exports.summarizeSessionTranscript = summarizeSessionTranscript;
        ...
        config: {
            ...
            tools: [{
                    functionDeclarations: [{
                            ...
                            behavior: genai_1.Behavior.NON_BLOCKING
                        }, {
...
async function summarizeSessionTranscript(transcriptText) {
